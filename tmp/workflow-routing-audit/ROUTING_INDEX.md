...
| R-005 | Git worktree lifecycle and conflict-first rules | Complete | `template/workflow/CONCURRENCY.md`, `template/scripts/setup-worktree.sh`, `template/workflow/ROUTING.md`, `template/workflow/FAILURE_ROUTING.md`, `template/workflow/ORCHESTRATOR.md` | `tmp/workflow-routing-audit/items/R-005-worktree-lifecycle-rules.md` |

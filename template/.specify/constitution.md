...
3. Capability 3: _description_

## Out-of-Scope Boundaries

`[PROJECT-SPECIFIC]` — What does this project deliberately refuse to become? What adjacent problems will we NOT solve? Be explicit — ambiguity here causes scope creep.

- Not: _thing we won't do_
- Not: _thing we won't do_

## Inviolable Principles

`[PROJECT-SPECIFIC]` — What principles hold even under pressure? What will we never compromise on, even if it slows us down?

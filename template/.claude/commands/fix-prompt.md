...
- .github/copilot-instructions.md (if the edit touches a Copilot-specific behavior)
- Any command files under .claude/commands/ (if the edit touches workflow logic)
- The workflow control-plane files (`LIFECYCLE.md`, `PLAYBOOK.md`, `FILE_CONTRACTS.md`, `FAILURE_ROUTING.md`) if sequencing or validation changed
- Governance files (`CHANGE_PROTOCOL.md`, `POLICY_TESTS.md`, `REGISTRY.md`) if policy behavior changed
